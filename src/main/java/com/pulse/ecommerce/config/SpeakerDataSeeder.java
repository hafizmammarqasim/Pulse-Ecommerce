...
import com.pulse.ecommerce.model.SpeakerInputOption;
...
public class SpeakerDataSeeder extends BaseSeeder implements CommandLineRunner {
  ...
  private void addInput(SpeakerProduct sp, String name) {
    SpeakerInputOption io = new SpeakerInputOption();
    io.setSpeakerProduct(sp);
    io.setInputName(name);
    inputRepo.save(io);
  }
  ...
  public void run(String... args) {
    ...
    addInput(s8, "Bluetooth");
    addInput(s8, "AUX");
    addInput(s8, "HDMI ARC");
