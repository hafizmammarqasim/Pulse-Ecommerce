...
public class DataSeeder implements CommandLineRunner {
 ...
 public void run(String... args) {
  ...
  // === MODIFIED PART: Seed admins and user idempotently ===
  seedUsers();
  ...
  // Variants (Price removed here, used for Stock/Color only)
  ...
  p2.setPrice(new BigDecimal("7999.00")); // Parent Price
  ...
  p3.setPrice(new BigDecimal("8999.00")); // Parent Price
  ...
  p4.setPrice(new BigDecimal("7499.00")); // Parent Price
  ...
  p5.setPrice(new BigDecimal("5999.00")); // Parent Price
  ...
  p6.setPrice(new BigDecimal("4499.00")); // Parent Price
  ...
  p7.setPrice(new BigDecimal("7999.00")); // Parent Price
  ...
  p8.setPrice(new BigDecimal("8999.00")); // Parent Price
  ...
  p9.setPrice(new BigDecimal("3499.00")); // Parent Price
  ...
  p10.setPrice(new BigDecimal("2999.00")); // Parent Price
  ...
  sp1.setOrder(null);
  sp1.setCustomer(userRepo.findByEmail("john@pulse.com").orElse(null)); // safe even if not exist yet
